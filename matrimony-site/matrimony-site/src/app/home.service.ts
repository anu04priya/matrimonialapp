...
export class HomeService {
  ...
  contacturi:string="http://localhost:8080/api/v1/addcontactus";
  ...
  public contact(contact:Contact):Observable<Customer>{
    return this.httpClient.post<Customer>(this.contacturi,contact);
  }
